...
local function fn()
    ...
    inst.AnimState:SetBank("fern_plant") -- This method sets our mobs bank file (what animations it has)
    inst.AnimState:SetBuild("fern_plant") -- This method sets our mobs build file (what assets it uses)
...
return Prefab("fern_plant", fn, assets) -- And we end the file by returning our prefab with the correct fn and assets
